...
This analysis dives into the dynamics of work hours, employment status, and income distribution within the U.S. labor market, revealing how factors like gender, age, and race shape people’s experiences. Using data from the IPUMS Current Population Survey (CPS) for 2024, we’ve created visualizations to bring these stories to life.

We start by looking at gender differences in employment status, then shift to examining how work hours vary across racial groups and different ages. Finally, we explore how income levels are tied to weekly hours worked, showing how lower and higher-income groups differ in their work patterns. Through these visualizations, we aim to capture the complexity of labor market disparities in a straightforward yet impactful way.
